 ...
 * @param {object} additionalNamespaces Optional hash of envelope namespaces.
 * @return {Promise<object>} A promise that resolves with a client object.
 */
function createClient(host, port, path, userId, password, service,
 ...
 */
function invokeMethod(client, cert, key, methodName, args) {
  return new Promise((resolve, reject) => {
    try {
